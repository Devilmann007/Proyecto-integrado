"""
Django settings for SICORA project.
...
SECRET_KEY = 'django-insecure-&6xw#-o@awk2$rts)4zc^n4ajy3%$bxo&_04q^k!*orxjgybeh'
...
ROOT_URLCONF = 'api_integrada.urls'
...
WSGI_APPLICATION = 'api_integrada.wsgi.application'
